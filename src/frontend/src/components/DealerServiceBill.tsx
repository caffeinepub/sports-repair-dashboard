...
export function DealerServiceBill({ job, open, onOpenChange }: Props) {
  if (!job) return null;
  ...
  function buildBillWhatsApp() {
    const lines = [
      "🏸 *CF Sports Repair — Dealer Service Bill*",
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent
        ...
        data-ocid="dealer_service_bill.dialog"
      >
        ...
        <div className="no-print px-6 pb-6 flex flex-col sm:flex-row gap-2">
          <Button
            ...
            onClick={handlePrint}
            data-ocid="dealer_service_bill.print_button"
          >
          ...
          <Button
            ...
            data-ocid="dealer_service_bill.whatsapp_button"
          >
          ...
          <Button
            variant="outline"
            onClick={() => onOpenChange(false)}
            data-ocid="dealer_service_bill.cancel_button"
          >
            Close
          </Button>
        </div>
