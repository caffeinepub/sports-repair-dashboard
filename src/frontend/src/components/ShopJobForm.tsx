...
export function ShopJobForm({ open, onOpenChange, editJob }: Props) {
        ...
        <DialogHeader>
          <div className="flex items-center gap-2">
            ...
            <DialogTitle className="text-lg font-bold text-green-800">
              {editJob ? "Edit Shop Job" : "New Shop Job"}
            </DialogTitle>
          </div>
        </DialogHeader>
        <form onSubmit={handleSubmit} className="space-y-5">
          {/* Section: Shop Details — green accent, most prominent */}
          <div className="rounded-xl border-2 border-green-200 bg-green-50/70 p-4 space-y-3">
            <h3 className="text-xs font-bold uppercase tracking-widest text-green-700 mb-1">
              🏪 Shop Details
            </h3>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              <div className="space-y-1.5">
                <Label htmlFor="sj-shopName">Shop Name *</Label>
                <Input
                  id="sj-shopName"
                  data-ocid="shop_job_form.input"
                  value={form.shopName}
                ...
                {errors.shopName && (
                  <p
                    ...
                    data-ocid="shop_job_form.error_state"
                  >
                    {errors.shopName}
                  </p>
                )}
              ...
              <div className="space-y-1.5">
                <Label htmlFor="sj-personName">Person Name *</Label>
                <Input
                  id="sj-personName"
                  data-ocid="shop_job_form.input"
              ...
              <div className="space-y-1.5">
                <Label htmlFor="sj-customerMobile">Mobile No *</Label>
                <Input
                  id="sj-customerMobile"
                  data-ocid="shop_job_form.input"
              ...
              <div className="space-y-1.5">
                <Label htmlFor="sj-place">Place / Location</Label>
                <Input
                  id="sj-place"
                  data-ocid="shop_job_form.input"
                  value={form.place}
          ...
          {/* Section: Service Details — blue accent */}
          <div className="rounded-xl border border-blue-200 bg-blue-50/60 p-4 space-y-3">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              <div className="space-y-1.5">
                ...
                >
                  <SelectTrigger
                    data-ocid="shop_job_form.select"
              ...
              <div className="space-y-1.5">
                <Label htmlFor="sj-dateOfJob">Date of Job *</Label>
                <Input
                  id="sj-dateOfJob"
                  data-ocid="shop_job_form.input"
                  type="date"
              ...
              <div className="space-y-1.5">
                <Label htmlFor="sj-noOfRackets">No. of Rackets</Label>
                <Input
                  id="sj-noOfRackets"
                  data-ocid="shop_job_form.input"
                  type="number"
              ...
              <div className="space-y-1.5">
                <Label htmlFor="sj-modelName">Racket Model Name</Label>
                <Input
                  id="sj-modelName"
                  data-ocid="shop_job_form.input"
          ...
          {/* Section: Notes */}
          <div className="space-y-1.5">
            <Label htmlFor="sj-jobDescription">Job Notes / Description</Label>
            <Textarea
              id="sj-jobDescription"
              data-ocid="shop_job_form.textarea"
          ...
          <div className="rounded-xl border border-amber-200 bg-amber-50/60 p-4 space-y-3">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              <div className="space-y-1.5">
                ...
                >
                  <SelectTrigger data-ocid="shop_job_form.select">
                    <SelectValue />
                  </SelectTrigger>
                  <SelectContent>
                    {PAYMENT_MODES.map((m) => (
              ...
              <div className="space-y-1.5">
                <Label htmlFor="sj-serviceCharges">Service Charges (₹)</Label>
                <Input
                  id="sj-serviceCharges"
                  data-ocid="shop_job_form.input"
                  type="number"
                  min="0"
              ...
              <div className="space-y-1.5">
                <Label htmlFor="sj-advancedAmount">Advanced Paid (₹)</Label>
                <Input
                  id="sj-advancedAmount"
                  data-ocid="shop_job_form.input"
                  type="number"
                  min="0"
              ...
              <div className="space-y-1.5">
                <Label htmlFor="sj-totalAmount">Total Amount (₹)</Label>
                <Input
                  id="sj-totalAmount"
                  data-ocid="shop_job_form.input"
                  type="number"
          ...
          <DialogFooter className="pt-2">
            <Button
              ...
              data-ocid="shop_job_form.cancel_button"
            >
              Cancel
            </Button>
            <Button
              type="submit"
              disabled={isPending}
              data-ocid="shop_job_form.submit_button"
