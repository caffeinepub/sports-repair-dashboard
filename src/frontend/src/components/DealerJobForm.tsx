...
export function DealerJobForm({ open, onOpenChange, editJob }: Props) {
  ...
  function validate(): boolean {
    ...
    if (!form.shopName.trim()) newErrors.shopName = "Dealer name is required";
    if (!form.personName.trim())
      newErrors.personName = "Contact person is required";
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent
        ...
        data-ocid="dealer_job_form.modal"
      >
        <DialogHeader>
          <div className="flex items-center gap-2">
            ...
            <DialogTitle className="text-lg font-bold text-blue-800">
              {editJob ? "Edit Dealer Job" : "New Dealer Job"}
            </DialogTitle>
          </div>
        </DialogHeader>
        <form onSubmit={handleSubmit} className="space-y-5">
          {/* Section: Dealer Details — blue accent, most prominent */}
          <div className="rounded-xl border-2 border-blue-200 bg-blue-50/70 p-4 space-y-3">
            <h3 className="text-xs font-bold uppercase tracking-widest text-blue-700 mb-1">
              🏬 Dealer Details
            </h3>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              <div className="space-y-1.5">
                <Label htmlFor="dj-dealerName">Dealer Name *</Label>
                <Input
                  id="dj-dealerName"
                  data-ocid="dealer_job_form.input"
                  value={form.shopName}
                  onChange={(e) => set("shopName", e.target.value)}
                  placeholder="e.g. Andhra Sports, Sports Hub"
                  className={
                    errors.shopName
                      ? "border-red-500"
                ...
                {errors.shopName && (
                  <p
                    ...
                    data-ocid="dealer_job_form.error_state"
                  >
                    {errors.shopName}
                  </p>
                )}
              ...
              <div className="space-y-1.5">
                <Label htmlFor="dj-personName">Contact Person *</Label>
                <Input
                  id="dj-personName"
                  data-ocid="dealer_job_form.input"
              ...
              <div className="space-y-1.5">
                <Label htmlFor="dj-customerMobile">Mobile No *</Label>
                <Input
                  id="dj-customerMobile"
                  data-ocid="dealer_job_form.input"
              ...
              <div className="space-y-1.5">
                <Label htmlFor="dj-place">Place / Location</Label>
                <Input
                  id="dj-place"
                  data-ocid="dealer_job_form.input"
                  value={form.place}
          ...
          {/* Section: Service Details — green accent */}
          <div className="rounded-xl border border-green-200 bg-green-50/60 p-4 space-y-3">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              <div className="space-y-1.5">
                ...
                >
                  <SelectTrigger
                    data-ocid="dealer_job_form.select"
              ...
              <div className="space-y-1.5">
                <Label htmlFor="dj-dateOfJob">Date of Job *</Label>
                <Input
                  id="dj-dateOfJob"
                  data-ocid="dealer_job_form.input"
                  type="date"
              ...
              <div className="space-y-1.5">
                <Label htmlFor="dj-noOfRackets">No. of Rackets</Label>
                <Input
                  id="dj-noOfRackets"
                  data-ocid="dealer_job_form.input"
                  type="number"
              ...
              <div className="space-y-1.5">
                <Label htmlFor="dj-modelName">Racket Model Name</Label>
                <Input
                  id="dj-modelName"
                  data-ocid="dealer_job_form.input"
          ...
          {/* Section: Notes */}
          <div className="space-y-1.5">
            <Label htmlFor="dj-jobDescription">Job Notes / Description</Label>
            <Textarea
              id="dj-jobDescription"
              data-ocid="dealer_job_form.textarea"
          ...
          <div className="rounded-xl border border-amber-200 bg-amber-50/60 p-4 space-y-3">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              <div className="space-y-1.5">
                ...
                >
                  <SelectTrigger data-ocid="dealer_job_form.select">
                    <SelectValue />
                  </SelectTrigger>
                  <SelectContent>
                    {PAYMENT_MODES.map((m) => (
              ...
              <div className="space-y-1.5">
                <Label htmlFor="dj-serviceCharges">Service Charges (₹)</Label>
                <Input
                  id="dj-serviceCharges"
                  data-ocid="dealer_job_form.input"
                  type="number"
                  min="0"
              ...
              <div className="space-y-1.5">
                <Label htmlFor="dj-advancedAmount">Advanced Paid (₹)</Label>
                <Input
                  id="dj-advancedAmount"
                  data-ocid="dealer_job_form.input"
                  type="number"
                  min="0"
              ...
              <div className="space-y-1.5">
                <Label htmlFor="dj-totalAmount">Total Amount (₹)</Label>
                <Input
                  id="dj-totalAmount"
                  data-ocid="dealer_job_form.input"
                  type="number"
          ...
          <DialogFooter className="pt-2">
            <Button
              ...
              data-ocid="dealer_job_form.cancel_button"
            >
              Cancel
            </Button>
            <Button
              type="submit"
              disabled={isPending}
              data-ocid="dealer_job_form.submit_button"
